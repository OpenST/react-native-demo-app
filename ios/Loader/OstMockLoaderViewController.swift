...
class OstMockLoaderViewController: UIViewController, OstWorkflowLoader {
  ...
  func addLayoutConstraints() {
    ...
    lastView.bottomAnchor.constraint(equalTo: lastView.superview!.bottomAnchor,  constant: -20).isActive = true
  ...
  func containerViewConstraints() {
    ...
    progressContainerView.leftAnchor.constraint(equalTo: parent.leftAnchor, constant: 20).isActive = true
    progressContainerView.rightAnchor.constraint(equalTo: parent.rightAnchor, constant: -20).isActive = true
  ...
  func progressImageViewConstraints() {
    ...
    progressImageView.topAnchor.constraint(equalTo: progressContainerView.topAnchor, constant: 20).isActive = true
    progressImageView.centerXAnchor.constraint(equalTo: parent.centerXAnchor).isActive = true
    progressImageView.widthAnchor.constraint(equalToConstant: 30).isActive = true
    progressImageView.heightAnchor.constraint(equalToConstant: 30).isActive = true
  }
  ...
  func messageLabelConstraints() {
    ...
    messageLabel.leftAnchor.constraint(equalTo: parent.leftAnchor, constant: 20).isActive = true
    messageLabel.rightAnchor.constraint(equalTo: parent.rightAnchor, constant: -20).isActive = true
  }
  ...
  func isUserCancelled(error: OstError) -> Bool {
